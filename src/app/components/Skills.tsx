...
import { FaReact, FaNodeJs, FaHtml5, FaCss3Alt, FaJsSquare, FaGitAlt, FaLinux, FaDocker } from 'react-icons/fa';
import { SiTypescript, SiNextdotjs, SiTailwindcss, SiNestjs } from 'react-icons/si';
    ...
    <section id="skills" className="py-20 bg-surface">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {skills.map((skill) => (
            <div key={skill.name} className="flex flex-col items-center p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
